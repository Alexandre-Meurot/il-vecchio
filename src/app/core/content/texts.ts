...
export const TEXTS = {
  ...
  home: {
    ...
    terraceText:
      'Installez-vous sur notre terrasse ou en salle et savourez votre pizza tout juste sortie ' +
  ...
  barTerrace: {
    ...
    introText: [
      'Notre terrasse vous accueille dans une ambiance chaleureuse. ' +
        'Que ce soit pour partager une pizza entre amis, ' +
    ...
    drinks: [
      {
        category: 'Vins',
        description: 'Au verre ou en bouteille',
    ...
    ambience: [
      {
        ...
        text: 'Une terrasse extérieure ombragée, parfaite pour un moment détendu.',
      },
      {
        icon: 'glass',
